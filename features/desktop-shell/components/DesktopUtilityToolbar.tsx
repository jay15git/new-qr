...
export const DESKTOP_UTILITY_TOOLBAR_BUTTON_CLASS =
  "grid size-10 place-items-center rounded-full text-current transition hover:bg-white/[0.11] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/45 max-md:size-9"
