...
export const DESKTOP_CANVAS_GLASS_TOOLBAR_SHELL_CLASS =
  "inline-flex min-h-12 cursor-pointer items-center gap-0.5 rounded-full border border-[var(--desktop-glass-border)] bg-[var(--desktop-glass-bg)] px-2.5 py-1 text-[var(--desktop-glass-fg)] shadow-[var(--desktop-glass-shadow)] backdrop-blur-2xl"

export const DESKTOP_CANVAS_GLASS_TOOLBAR_VERTICAL_SHELL_CLASS =
  "inline-flex min-w-12 cursor-pointer flex-col items-center gap-0.5 rounded-full border border-[var(--desktop-glass-border)] bg-[var(--desktop-glass-bg)] px-1 py-2.5 text-[var(--desktop-glass-fg)] shadow-[var(--desktop-glass-shadow)] backdrop-blur-2xl"
