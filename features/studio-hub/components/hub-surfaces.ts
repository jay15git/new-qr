export const HUB_CARD_SURFACE =
  "rounded-2xl border border-transparent bg-[var(--drafting-option-card-bg)] shadow-[var(--drafting-option-card-shadow-rest)] transition-shadow duration-300 hover:shadow-[var(--drafting-option-card-shadow-hover)]"

export const HUB_PILL_SURFACE =
  "rounded-full border border-transparent bg-[var(--desktop-inspector-field-bg)] shadow-[var(--drafting-shadow-rest)] transition-shadow duration-300 hover:shadow-[var(--drafting-shadow-hover)]"

export const HUB_CATEGORY_PILL_SURFACE =
