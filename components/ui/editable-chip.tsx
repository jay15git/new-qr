...
export const EditableChip: FC<EditableChipProps> = ({
  ...
  return (
      <motion.div layout>
        <div
          className={cn(
            `relative flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full border-none py-1 pr-1 transition-all duration-300 ease-in-out select-none dark:bg-zinc-900`,
