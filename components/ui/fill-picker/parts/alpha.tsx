...
export const Alpha = React.forwardRef<HTMLDivElement, AlphaProps>(function Alpha(
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "relative cursor-ew-resize rounded-full shadow-[0_0_0_1px_var(--color-picker-control-border,var(--border)),0_1px_0_var(--color-picker-highlight,rgba(255,255,255,0.08))_inset] outline-none touch-none",
