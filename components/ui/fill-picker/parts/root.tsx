  ...
  return (
    <ColorPickerContext.Provider value={state}>
      <div
        ...
        className={cn(
          "flex w-full max-w-[280px] flex-col gap-2 rounded-lg border border-[var(--color-picker-border,var(--border))] bg-[var(--color-picker-bg,var(--popover))] p-3 text-[var(--color-picker-fg,var(--popover-foreground))] shadow-sm",
          className,
        )}
        {...rest}
      >
