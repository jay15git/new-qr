      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          style={{
            ...
            backgroundColor: checked
              ? hovered
                ? "var(--fluid-switch-track-on-hover)"
                : "var(--fluid-switch-track-on)"
              : hovered
                ? "var(--fluid-switch-track-off-hover)"
                : "var(--fluid-switch-track-off)",
          }}
        ...
        >
          <SwitchPrimitive.Thumb asChild>
            <motion.span
              className={cn(
                "absolute top-0 left-0 block rounded-full shadow-sm",
                checked
                  ? "bg-[var(--fluid-switch-thumb-on)]"
                  : "bg-[var(--fluid-switch-thumb-off)]",
              )}
              initial={false}
              style={{ x: motionX }}
              animate={{
