  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        palette.folder,
        palette.folderBorder,
        className,
      )}
    >
      <div className="absolute right-0 bottom-0 left-0 z-20">
        <div className="flex items-end">
          <div className={cn(dimensions.tabLeft, "backdrop-blur-sm", palette.flap)} />
          <div className={cn(dimensions.tabRight, "backdrop-blur-sm", palette.flap)} />
          <div
            className={cn(
              dimensions.tabBridge,
        ...
        <div
          className={cn(
            dimensions.flapBody,
            "rounded-tr-xl backdrop-blur-sm",
            palette.flap,
          )}
        />
      </div>

      <div className={cn("absolute z-10", dimensions.papers)}>
        <motion.div
          variants={{
            rest: { rotate: 4, y: 0, transition: spring },
            hover: { rotate: 6, y: dimensions.hoverBackY, transition: spring },
          }}
          style={{ originY: 1 }}
          className={cn(
            "absolute inset-x-0 rounded-2xl",
            dimensions.paperOffset,
            dimensions.paperH,
            palette.paperBack,
          )}
        />
        ...
        <motion.div
          variants={{
            ...
            hover: { y: dimensions.hoverY, transition: spring },
          }}
          className={cn(
        ...
        >
          <div className={dimensions.paperContent}>
            <div className={cn("h-1 w-3/4 rounded-full", palette.paperLine)} />
            <div className={cn("h-1 w-1/2 rounded-full", palette.paperLine)} />
            <div className={cn("h-1 w-2/3 rounded-full", palette.paperLine)} />
          </div>
        </motion.div>
      </div>

      {label ? (
        <div className={cn("absolute z-20 rounded-full", dimensions.label, palette.labelBg)}>
