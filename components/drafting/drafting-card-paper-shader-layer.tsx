...
import type { DraftingCardPaperShaderState } from "@/components/drafting/drafting-card-state"
import { getPaperShaderDefinition } from "@/components/drafting/drafting-paper-shaders"
